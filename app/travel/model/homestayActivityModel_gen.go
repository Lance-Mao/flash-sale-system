...
var (
	...
	cacheflashsaleTravelHomestayActivityIdPrefix = "cache:flashsaleTravel:homestayActivity:id:"
)
...
func (m *defaultHomestayActivityModel) Insert(ctx context.Context, session sqlx.Session, data *HomestayActivity) (sql.Result, error) {
	...
	flashsaleTravelHomestayActivityIdKey := fmt.Sprintf("%s%v", cacheflashsaleTravelHomestayActivityIdPrefix, data.Id)
	...
	}, flashsaleTravelHomestayActivityIdKey)
}

func (m *defaultHomestayActivityModel) FindOne(ctx context.Context, id int64) (*HomestayActivity, error) {
	flashsaleTravelHomestayActivityIdKey := fmt.Sprintf("%s%v", cacheflashsaleTravelHomestayActivityIdPrefix, id)
	var resp HomestayActivity
	err := m.QueryRowCtx(ctx, &resp, flashsaleTravelHomestayActivityIdKey, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) error {
...
func (m *defaultHomestayActivityModel) formatPrimary(primary interface{}) string {
	return fmt.Sprintf("%s%v", cacheflashsaleTravelHomestayActivityIdPrefix, primary)
}
