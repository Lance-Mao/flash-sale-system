...
import (
	...
	"database/sql"
	"fmt"
	"github.com/Lance-Mao/flash-sale-system/deploy/script/mysql/genModel"
	"strings"
...
var (
	...
	cacheflashsaleUsercenterUserAuthIdPrefix              = "cache:flashsaleUsercenter:userAuth:id:"
	cacheflashsaleUsercenterUserAuthAuthTypeAuthKeyPrefix = "cache:flashsaleUsercenter:userAuth:authType:authKey:"
	cacheflashsaleUsercenterUserAuthUserIdAuthTypePrefix  = "cache:flashsaleUsercenter:userAuth:userId:authType:"
)
...
func (m *defaultUserAuthModel) Insert(ctx context.Context, session sqlx.Session, data *UserAuth) (sql.Result, error) {
	...
	flashsaleUsercenterUserAuthAuthTypeAuthKeyKey := fmt.Sprintf("%s%v:%v", cacheflashsaleUsercenterUserAuthAuthTypeAuthKeyPrefix, data.AuthType, data.AuthKey)
	flashsaleUsercenterUserAuthIdKey := fmt.Sprintf("%s%v", cacheflashsaleUsercenterUserAuthIdPrefix, data.Id)
	flashsaleUsercenterUserAuthUserIdAuthTypeKey := fmt.Sprintf("%s%v:%v", cacheflashsaleUsercenterUserAuthUserIdAuthTypePrefix, data.UserId, data.AuthType)
	...
	}, flashsaleUsercenterUserAuthAuthTypeAuthKeyKey, flashsaleUsercenterUserAuthIdKey, flashsaleUsercenterUserAuthUserIdAuthTypeKey)
}

func (m *defaultUserAuthModel) FindOne(ctx context.Context, id int64) (*UserAuth, error) {
	flashsaleUsercenterUserAuthIdKey := fmt.Sprintf("%s%v", cacheflashsaleUsercenterUserAuthIdPrefix, id)
	var resp UserAuth
	err := m.QueryRowCtx(ctx, &resp, flashsaleUsercenterUserAuthIdKey, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) error {
...
func (m *defaultUserAuthModel) FindOneByAuthTypeAuthKey(ctx context.Context, authType string, authKey string) (*UserAuth, error) {
	flashsaleUsercenterUserAuthAuthTypeAuthKeyKey := fmt.Sprintf("%s%v:%v", cacheflashsaleUsercenterUserAuthAuthTypeAuthKeyPrefix, authType, authKey)
	var resp UserAuth
	err := m.QueryRowIndexCtx(ctx, &resp, flashsaleUsercenterUserAuthAuthTypeAuthKeyKey, m.formatPrimary, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) (i interface{}, e error) {
...
func (m *defaultUserAuthModel) FindOneByUserIdAuthType(ctx context.Context, userId int64, authType string) (*UserAuth, error) {
	flashsaleUsercenterUserAuthUserIdAuthTypeKey := fmt.Sprintf("%s%v:%v", cacheflashsaleUsercenterUserAuthUserIdAuthTypePrefix, userId, authType)
	var resp UserAuth
	err := m.QueryRowIndexCtx(ctx, &resp, flashsaleUsercenterUserAuthUserIdAuthTypeKey, m.formatPrimary, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) (i interface{}, e error) {
...
func (m *defaultUserAuthModel) formatPrimary(primary interface{}) string {
	return fmt.Sprintf("%s%v", cacheflashsaleUsercenterUserAuthIdPrefix, primary)
}
