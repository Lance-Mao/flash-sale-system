...
var (
	...
	cacheflashsaleUsercenterUserIdPrefix     = "cache:flashsaleUsercenter:user:id:"
	cacheflashsaleUsercenterUserMobilePrefix = "cache:flashsaleUsercenter:user:mobile:"
)
...
func (m *defaultUserModel) Insert(ctx context.Context, session sqlx.Session, data *User) (sql.Result, error) {
	...
	flashsaleUsercenterUserIdKey := fmt.Sprintf("%s%v", cacheflashsaleUsercenterUserIdPrefix, data.Id)
	flashsaleUsercenterUserMobileKey := fmt.Sprintf("%s%v", cacheflashsaleUsercenterUserMobilePrefix, data.Mobile)
	...
	}, flashsaleUsercenterUserIdKey, flashsaleUsercenterUserMobileKey)
}

func (m *defaultUserModel) FindOne(ctx context.Context, id int64) (*User, error) {
	flashsaleUsercenterUserIdKey := fmt.Sprintf("%s%v", cacheflashsaleUsercenterUserIdPrefix, id)
	var resp User
	err := m.QueryRowCtx(ctx, &resp, flashsaleUsercenterUserIdKey, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) error {
...
func (m *defaultUserModel) FindOneByMobile(ctx context.Context, mobile string) (*User, error) {
	flashsaleUsercenterUserMobileKey := fmt.Sprintf("%s%v", cacheflashsaleUsercenterUserMobilePrefix, mobile)
	var resp User
	err := m.QueryRowIndexCtx(ctx, &resp, flashsaleUsercenterUserMobileKey, m.formatPrimary, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) (i interface{}, e error) {
...
func (m *defaultUserModel) formatPrimary(primary interface{}) string {
	return fmt.Sprintf("%s%v", cacheflashsaleUsercenterUserIdPrefix, primary)
}
