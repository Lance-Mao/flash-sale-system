...
var (
	...
	cacheflashsalePaymentThirdPaymentIdPrefix = "cache:flashsalePayment:thirdPayment:id:"
	cacheflashsalePaymentThirdPaymentSnPrefix = "cache:flashsalePayment:thirdPayment:sn:"
)
...
func (m *defaultThirdPaymentModel) Insert(ctx context.Context, session sqlx.Session, data *ThirdPayment) (sql.Result, error) {
	...
	flashsalePaymentThirdPaymentIdKey := fmt.Sprintf("%s%v", cacheflashsalePaymentThirdPaymentIdPrefix, data.Id)
	flashsalePaymentThirdPaymentSnKey := fmt.Sprintf("%s%v", cacheflashsalePaymentThirdPaymentSnPrefix, data.Sn)
	...
	}, flashsalePaymentThirdPaymentIdKey, flashsalePaymentThirdPaymentSnKey)
}

func (m *defaultThirdPaymentModel) FindOne(ctx context.Context, id int64) (*ThirdPayment, error) {
	flashsalePaymentThirdPaymentIdKey := fmt.Sprintf("%s%v", cacheflashsalePaymentThirdPaymentIdPrefix, id)
	var resp ThirdPayment
	err := m.QueryRowCtx(ctx, &resp, flashsalePaymentThirdPaymentIdKey, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) error {
...
func (m *defaultThirdPaymentModel) FindOneBySn(ctx context.Context, sn string) (*ThirdPayment, error) {
	flashsalePaymentThirdPaymentSnKey := fmt.Sprintf("%s%v", cacheflashsalePaymentThirdPaymentSnPrefix, sn)
	var resp ThirdPayment
	err := m.QueryRowIndexCtx(ctx, &resp, flashsalePaymentThirdPaymentSnKey, m.formatPrimary, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) (i interface{}, e error) {
...
func (m *defaultThirdPaymentModel) formatPrimary(primary interface{}) string {
	return fmt.Sprintf("%s%v", cacheflashsalePaymentThirdPaymentIdPrefix, primary)
}
