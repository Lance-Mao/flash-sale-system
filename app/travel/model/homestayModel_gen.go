...
var (
	...
	cacheflashsaleTravelHomestayIdPrefix = "cache:flashsaleTravel:homestay:id:"
)
...
func (m *defaultHomestayModel) Insert(ctx context.Context, session sqlx.Session, data *Homestay) (sql.Result, error) {
	...
	flashsaleTravelHomestayIdKey := fmt.Sprintf("%s%v", cacheflashsaleTravelHomestayIdPrefix, data.Id)
	...
	}, flashsaleTravelHomestayIdKey)
}

func (m *defaultHomestayModel) FindOne(ctx context.Context, id int64) (*Homestay, error) {
	flashsaleTravelHomestayIdKey := fmt.Sprintf("%s%v", cacheflashsaleTravelHomestayIdPrefix, id)
	var resp Homestay
	err := m.QueryRowCtx(ctx, &resp, flashsaleTravelHomestayIdKey, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) error {
...
func (m *defaultHomestayModel) formatPrimary(primary interface{}) string {
	return fmt.Sprintf("%s%v", cacheflashsaleTravelHomestayIdPrefix, primary)
}
