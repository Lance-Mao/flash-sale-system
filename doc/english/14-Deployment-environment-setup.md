...
Click on the project, go back to the project you just created, Will flash-sale-system Project upload to this warehouse ssh://git@192.168.1.180:2222/root/flash-sale-system.git To, and our gitlab build is over.
...
![image-20220209191757422](../chinese/images/14/image-20220209191757422.png)
 ...
 ```shell
 docker push 192.168.1.180:8077/flash-sale-system/REPOSITORY[:TAG]
 ```
