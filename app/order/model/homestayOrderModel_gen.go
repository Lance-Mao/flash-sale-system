...
var (
	...
	cacheflashsaleOrderHomestayOrderIdPrefix = "cache:flashsaleOrder:homestayOrder:id:"
	cacheflashsaleOrderHomestayOrderSnPrefix = "cache:flashsaleOrder:homestayOrder:sn:"
)
...
func (m *defaultHomestayOrderModel) Insert(ctx context.Context, session sqlx.Session, data *HomestayOrder) (sql.Result, error) {
	...
	flashsaleOrderHomestayOrderIdKey := fmt.Sprintf("%s%v", cacheflashsaleOrderHomestayOrderIdPrefix, data.Id)
	flashsaleOrderHomestayOrderSnKey := fmt.Sprintf("%s%v", cacheflashsaleOrderHomestayOrderSnPrefix, data.Sn)
	...
	}, flashsaleOrderHomestayOrderIdKey, flashsaleOrderHomestayOrderSnKey)
}

func (m *defaultHomestayOrderModel) FindOne(ctx context.Context, id int64) (*HomestayOrder, error) {
	flashsaleOrderHomestayOrderIdKey := fmt.Sprintf("%s%v", cacheflashsaleOrderHomestayOrderIdPrefix, id)
	var resp HomestayOrder
	err := m.QueryRowCtx(ctx, &resp, flashsaleOrderHomestayOrderIdKey, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) error {
...
func (m *defaultHomestayOrderModel) FindOneBySn(ctx context.Context, sn string) (*HomestayOrder, error) {
	flashsaleOrderHomestayOrderSnKey := fmt.Sprintf("%s%v", cacheflashsaleOrderHomestayOrderSnPrefix, sn)
	var resp HomestayOrder
	err := m.QueryRowIndexCtx(ctx, &resp, flashsaleOrderHomestayOrderSnKey, m.formatPrimary, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) (i interface{}, e error) {
...
func (m *defaultHomestayOrderModel) formatPrimary(primary interface{}) string {
	return fmt.Sprintf("%s%v", cacheflashsaleOrderHomestayOrderIdPrefix, primary)
}
