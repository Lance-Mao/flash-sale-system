...
var (
	...
	cacheflashsaleTravelHomestayCommentIdPrefix = "cache:flashsaleTravel:homestayComment:id:"
)
...
func (m *defaultHomestayCommentModel) Insert(ctx context.Context, session sqlx.Session, data *HomestayComment) (sql.Result, error) {
	...
	flashsaleTravelHomestayCommentIdKey := fmt.Sprintf("%s%v", cacheflashsaleTravelHomestayCommentIdPrefix, data.Id)
	...
	}, flashsaleTravelHomestayCommentIdKey)
}

func (m *defaultHomestayCommentModel) FindOne(ctx context.Context, id int64) (*HomestayComment, error) {
	flashsaleTravelHomestayCommentIdKey := fmt.Sprintf("%s%v", cacheflashsaleTravelHomestayCommentIdPrefix, id)
	var resp HomestayComment
	err := m.QueryRowCtx(ctx, &resp, flashsaleTravelHomestayCommentIdKey, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) error {
...
func (m *defaultHomestayCommentModel) formatPrimary(primary interface{}) string {
	return fmt.Sprintf("%s%v", cacheflashsaleTravelHomestayCommentIdPrefix, primary)
}
