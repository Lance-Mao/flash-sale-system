...
var (
	...
	cacheflashsaleTravelHomestayBusinessIdPrefix     = "cache:flashsaleTravel:homestayBusiness:id:"
	cacheflashsaleTravelHomestayBusinessUserIdPrefix = "cache:flashsaleTravel:homestayBusiness:userId:"
)
...
func (m *defaultHomestayBusinessModel) Insert(ctx context.Context, session sqlx.Session, data *HomestayBusiness) (sql.Result, error) {
	...
	flashsaleTravelHomestayBusinessIdKey := fmt.Sprintf("%s%v", cacheflashsaleTravelHomestayBusinessIdPrefix, data.Id)
	flashsaleTravelHomestayBusinessUserIdKey := fmt.Sprintf("%s%v", cacheflashsaleTravelHomestayBusinessUserIdPrefix, data.UserId)
	...
	}, flashsaleTravelHomestayBusinessIdKey, flashsaleTravelHomestayBusinessUserIdKey)
}

func (m *defaultHomestayBusinessModel) FindOne(ctx context.Context, id int64) (*HomestayBusiness, error) {
	flashsaleTravelHomestayBusinessIdKey := fmt.Sprintf("%s%v", cacheflashsaleTravelHomestayBusinessIdPrefix, id)
	var resp HomestayBusiness
	err := m.QueryRowCtx(ctx, &resp, flashsaleTravelHomestayBusinessIdKey, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) error {
...
func (m *defaultHomestayBusinessModel) FindOneByUserId(ctx context.Context, userId int64) (*HomestayBusiness, error) {
	flashsaleTravelHomestayBusinessUserIdKey := fmt.Sprintf("%s%v", cacheflashsaleTravelHomestayBusinessUserIdPrefix, userId)
	var resp HomestayBusiness
	err := m.QueryRowIndexCtx(ctx, &resp, flashsaleTravelHomestayBusinessUserIdKey, m.formatPrimary, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) (i interface{}, e error) {
...
func (m *defaultHomestayBusinessModel) formatPrimary(primary interface{}) string {
	return fmt.Sprintf("%s%v", cacheflashsaleTravelHomestayBusinessIdPrefix, primary)
}
