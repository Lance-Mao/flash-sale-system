...
A good service must be able to be monitored in time, in flash-sale-system we use the currently popular prometheus as a monitoring tool, and then use grafana to show
